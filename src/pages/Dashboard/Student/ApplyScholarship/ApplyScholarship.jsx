	...
	return (
		...
		<div>
          ...
          <form onSubmit={handleApplicationSubmit} className="max-w-2xl mx-auto bg-white shadow-md p-6 rounded-lg border border-gray-200 space-y-4">
            ...
            <input name="universityName" type="text" value={scholarship.universityName} className="input input-bordered w-full" readOnly />
            <input name="scholarshipCategory" type="text" value={scholarship.scholarshipCategory} className="input input-bordered w-full" readOnly />
            <input name="subjectCategory" type="text" value={scholarship.subjectCategory} className="input input-bordered w-full" readOnly />
