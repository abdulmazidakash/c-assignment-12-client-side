...
import { FaUserEdit, FaClipboardCheck, FaStarHalfAlt, FaPlusCircle } from 'react-icons/fa';
  ...
  return (
    <div className="p-6 min-h-screen">
      ...
      <div className="">
        ...
        <MenuItem label="Add Scholarship" address="/moderator-add-scholarship" icon={FaPlusCircle} />
      </div>
    </div>
  );
}
